...
<div id="categories_title" class="row">
    ...
    <div class="col-md-10">  
        <?php if ($is_root): ?>   
            ...
            <hr>
        <?php else: ?>    
            <h3>Metadados de <?php echo $category->name; ?> <button style="font-size: 26px;" type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></h3>  
             <hr>
        <?php endif; ?>  
...
<div class="categories_menu" class="row"  id="properties_tabs">
    <div class="col-md-1">
        <?php if (!$is_root): ?> 
            <div id="property_category_dynatree" style="display: none;height: 500px;" >
            </div>
        <?php endif; ?> 
    </div>
