...
<?php // excluir propriedades     ?>
    function delete_property(element) {
            ...
            if (elem.no_properties !== true) {
                ...
                $.each(elem.property_data, function (idx, property) {
                    if (property.metas.is_repository_property && property.metas.is_repository_property === true ||
                        ...
                        $('#table_property_data').append('<tr><td>' + property.name + '</td><td>' + property.type + '</td><td><input type="hidden" class="property_data_id" value="' + property.id + '"><a onclick="edit_data(this)" class="edit_property_data" href="#submit_form_property_data"><span class="glyphicon glyphicon-edit"><span></a></td><td><input type="hidden" class="property_id" value="' + property.id + '"><input type="hidden" class="property_name" value="' + property.name + '"><a onclick="delete_property(this)" class="delete_property" href="#"><span class="glyphicon glyphicon-remove"><span></a></td></tr>');
                    }
            ...
            if (elem.no_properties !== true) {
                ...
                $.each(elem.property_object, function (idx, property) {
                    if (property.metas.is_repository_property && property.metas.is_repository_property === true ||
                        ...
                        $('#table_property_object').append('<tr><td>' + property.name + '</td><td>' + property.type + '</td><td><input type="hidden" class="property_object_id" value="' + property.id + '"><a onclick="edit_object(this)" class="edit_property_object" href="#submit_form_property_object"><span class="glyphicon glyphicon-edit"><span></a></td><td><input type="hidden" class="property_id" value="' + property.id + '"><input type="hidden" class="property_name" value="' + property.name + '"><a onclick="delete_property(this)" class="delete_property" href="#"><span class="glyphicon glyphicon-remove"><span></a></td></tr>');
                    }
                });
            ...
            if (elem && elem.no_properties !== true) {
                ...
                $.each(elem.property_terms, function (idx, property) {
                    if (property.metas.is_repository_property && property.metas.is_repository_property === true ||
                        ...
                        $('#table_property_term').append('<tr><td>' + property.name + '</td><td>' + property.type + '</td><td><input type="hidden" class="property_term_id" value="' + property.id + '"><a onclick="edit_term(this)" class="edit_property_term" href="#submit_form_property_term"><span class="glyphicon glyphicon-edit"><span></a></td><td><input type="hidden" class="property_id" value="' + property.id + '"><input type="hidden" class="property_name" value="' + property.name + '"><a onclick="delete_property(this)" class="delete_property" href="#"><span class="glyphicon glyphicon-remove"><span></a></td></tr>');
                    }
                });
