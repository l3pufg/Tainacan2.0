        ...
        <div>
            <form  id="submit_form_search_data">
                ...
                <div id="color_field_property_search" style="display: none;">
                    ...
                    for ($i = 1; $i < 14; $i++) {
                        echo '<label class="radio-inline">
                                            <input type="radio" name="color_facet" id="color_property' . $i . '" value="color_property' . $i . '" ';
                        //  if ($collection_metas['socialdb_collection_facet_' . $facet->term_id . '_color'] == "color" . $i) {
                        //    echo 'checked="checked"';
                        //    }
                ...
                <div id="orientation_field" class="form-group">
                    ...
                    <select class="form-control" id="search_data_orientation" name="search_data_orientation">
                        <option  value="left-column"><?php _e('Left Column','tainacan'); ?></option>
                        <option disabled="disabled" value="right-column"><?php _e('Right Column','tainacan'); ?></option>
                         <option disabled="disabled" value="horizontal"><?php _e('Horizontal','tainacan'); ?></option>
                    </select>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <input type="radio" id="widget_tree_orientation_left" name="socialdb_collection_widget_tree_orientation" onclick="save_widget_tree_orientation(this);" value="left-column" <?php
