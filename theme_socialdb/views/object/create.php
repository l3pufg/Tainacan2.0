...
?>
<h3><?php _e('Add New Object','tainacan'); ?><button onclick="back_main_list();"class="btn btn-default pull-right"><b><?php _e('Back','tainacan') ?></b></button></h3>
...
<form  id="submit_form">
   ...
   <div id="object_content_text" class="form-group">
    ...
    <div id="thumb-idea-form">
        <label for="object_thumbnail"><?php _e('Item Thumbnail','tainacan'); ?></label>
    ...
    <div id="dropzone_new" <?php if($socialdb_collection_attachment=='no') echo 'style="display:none"' ?> class="dropzone">
    </div>
    <div class="form-group">
