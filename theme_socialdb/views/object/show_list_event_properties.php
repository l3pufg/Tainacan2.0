        ...
        //if ($property['metas']['socialdb_property_object_is_facet'] == 'false'):
            ...
            <div class="form-group">
                <label for="object_tags"><?php echo $property['name']; ?></label>
                    ...
                    <select onclick="clear_select_object_property(this);"  id="property_value_<?php echo $property['id']; ?>_<?php echo $object_id; ?>" multiple class="chosen-selected2 form-control" style="height: auto;" multiple name="category_moderators[]" id="chosen-selected2-user" disabled="disabled" >
    ...
    foreach ($property_data as $property) {
        ...
        <div class="form-group">
         ...
         <?php if ($property['type'] == 'text') { ?>     
                <input  disabled="disabled" value="<?php if($property['metas']['value']) echo $property['metas']['value'][0]; ?>" type="text" id="property_value_<?php echo $property['id']; ?>_<?php echo $object_id; ?>" class="form-control" name="socialdb_property_<?php echo $property['id']; ?>" <?php if (!$property['metas']['socialdb_property_required']): echo 'required="required"';
            endif; ?>>
        <?php }elseif ($property['type'] == 'textarea') {  ?>   
                <textarea rows="15" disabled="disabled" id="property_value_<?php echo $property['id']; ?>_<?php echo $object_id; ?>" class="form-control" name="socialdb_property_<?php echo $property['id']; ?>" <?php if (!$property['metas']['socialdb_property_required']): echo 'required="required"';
            endif; ?>><?php if($property['metas']['value']) echo $property['metas']['value'][0]; ?></textarea>
        <?php }elseif ($property['type'] == 'numeric') {  ?>   
                <input disabled="disabled" value="<?php if($property['metas']['value']) echo $property['metas']['value'][0]; ?>" type="number" id="property_value_<?php echo $property['id']; ?>_<?php echo $object_id; ?>" class="form-control" name="socialdb_property_<?php echo $property['id']; ?>" <?php if (!$property['metas']['socialdb_property_required']): echo 'required="required"';
            endif; ?>>
        <?php }else { 
            $property['metas']['value'][0] = implode('/',array_reverse(explode('-',  $property['metas']['value'][0]))); ?> 
                <input disabled="disabled" value="<?php if($property['metas']['value']) echo $property['metas']['value'][0]; ?>" id="property_value_<?php echo $property['id']; ?>_<?php echo $object_id; ?>" type="text" class="form-control input_date" name="socialdb_property_<?php echo $property['id']; ?>" <?php if (!$property['metas']['socialdb_property_required']): echo 'required="required"';
            endif; ?>>
        <?php } ?> 
            <input type="hidden" id="property_<?php echo $property['id']; ?>_<?php echo $object_id; ?>_value_before" name="property_<?php echo $property['id']; ?>_<?php echo $object_id; ?>_value_before" value="<?php if (is_array($property['metas']['value'])) echo implode(',', is_array($property['metas']['value'])); ?>">
        </div>              
