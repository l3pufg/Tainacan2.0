   ...
   /******************************* AO SELECIONAR OS ITEMS VIA CHECKBOX *********************/
    function selectedItems(){
        ...
        if(selected_items.length==1){// quando selecionado um item seus valores vao para o form a esquerda
            ...
            var dataProperties = $("#multiple_properties_data_id").val().split(',').filter(function(v){return v!==''});
            ...
            //BUSCANDO VALORES das **propriedades de termos** para o item selecionado
                //checkbox
            var checkboxes = $("#multiple_properties_terms_checkbox").val().split(',').filter(function(v){return v!==''});
            for(var i = 0;i<checkboxes.length;i++){
                $.each($("input:checkbox[name='multiple_socialdb_propertyterm_"+checkboxes[i]+"']:checked"), function(){       
                    $(this).removeAttr('checked');
                });
                var categories =  $("#socialdb_property_"+checkboxes[i]+"_"+item_id).val().split(',').filter(function(v){return v!==''});
                ...
                //multipleSelect
            var multipleSelects = $("#multiple_properties_terms_multipleselect").val().split(',').filter(function(v){return v!==''});
            for(var i = 0;i<multipleSelects.length;i++){
                $("select[name='multiple_socialdb_propertyterm_"+multipleSelects[i]+"']").val([]);
                var categories =  $("#socialdb_property_"+multipleSelects[i]+"_"+item_id).val().split(',').filter(function(v){return v!==''});
                ...
                //dynatree checkbox
            var multiple_properties_terms_treecheckbox = $("#multiple_properties_terms_treecheckbox").val().split(',').filter(function(v){return v!==''});
            for(var i = 0;i<multiple_properties_terms_treecheckbox.length;i++){
                var categories =  $("#socialdb_property_"+multiple_properties_terms_treecheckbox[i]+"_"+item_id).val().split(',').filter(function(v){return v!==''});
                ...
                //radio
            var radios = $("#multiple_properties_terms_radio").val().split(',').filter(function(v){return v!==''});
            for(var i = 0;i<radios.length;i++){
             ...
             //select
            var select = $("#multiple_properties_terms_selectbox").val().split(',').filter(function(v){return v!==''});
            for(var i = 0;i<select.length;i++){
             ...
             //dynatree radio
            var multiple_properties_terms_tree = $("#multiple_properties_terms_tree").val().split(',').filter(function(v){return v!==''});
            for(var i = 0;i<multiple_properties_terms_tree.length;i++){
                var categories =  $("#socialdb_property_"+multiple_properties_terms_tree[i]+"_"+item_id).val().split(',').filter(function(v){return v!==''});
            ...
            var objectProperties = $("#multiple_properties_object_id").val().split(',').filter(function(v){return v!==''});
            for(var i = 0;i<objectProperties.length;i++){
                var allValues = [];
                $("#multiple_property_value_" + objectProperties[i] + "_<?php echo $object_id ?>_add option:selected").each(function () {
            ...
            for(var i = 0;i<checkboxes.length;i++){
                ...
                $.each($("input:checkbox[name='selected_items']:checked"), function(){  // varro todos os objetos     
                         var categories =  $("#socialdb_property_"+checkboxes[i]+"_"+$(this).val()).val().split(',').filter(function(v){return v!==''});
                         $.each($("input:checkbox[name='multiple_socialdb_propertyterm_"+checkboxes[i]+"']"), function(){       
                            if(categories.length>0&&categories.indexOf($(this).val())>=0){
                                $(this).attr('checked','checked');
                            }
            ...
            for(var i = 0;i<multipleSelects.length;i++){
                $("select[name='multiple_socialdb_propertyterm_"+multipleSelects[i]+"']").val([]);
                $.each($("input:checkbox[name='selected_items']:checked"), function(){  // varro todos os objetos     
                    var categories =  $("#socialdb_property_"+multipleSelects[i]+"_"+$(this).val()).val().split(',').filter(function(v){return v!==''});
                    $.each($("select[name='multiple_socialdb_propertyterm_"+multipleSelects[i]+"'] option"), function(){       
                        if(categories.length>0&&categories.indexOf($(this).val())>=0){
                            $(this).attr('selected','selected');
                        }
            ...
            for(var i = 0;i<multiple_properties_terms_treecheckbox.length;i++){
                ...
                // });
                $.each($("input:checkbox[name='selected_items']:checked"), function(){  // varro todos os objetos     
                    var categories =  $("#socialdb_property_"+multiple_properties_terms_treecheckbox[i]+"_"+$(this).val()).val().split(',').filter(function(v){return v!==''});
                    $("#multiple_field_property_term_"+multiple_properties_terms_treecheckbox[i]).dynatree("getRoot").visit(function(node){
                          if(categories.length>0&&categories.indexOf(node.data.key)>=0){
                                 node.select(true);
                           }
    ...
    function removePropertyObject(object,property_id){
        ...
        if(object!=''){
            $.each($("input:checkbox[name='selected_items']:checked"), function(){      
                var array = $("#socialdb_property_"+property_id+"_"+$(this).val()).val().split('||').filter(function(v){return v!==''}); // TORNA O VALOR DO hidden em arrya para poder adicionar
