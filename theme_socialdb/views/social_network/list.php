...
<div class="row">
    ...
    <div class="col-md-10" id="edit_mapping" style="display: none;"></div>
    <div class="col-md-10" id="list_social_network">
        <div class="row">
           <div id="loader_videos" style="margin-left: 35%;margin-top:3%"><img src="<?php echo get_template_directory_uri(), '/libraries/images/ajaxLoader.gif';?>" /></div>
            <h3>
           ...
           <hr>
            ...
            <div class="tab-content">
                ...
                <div id="aba-youtube" class="tab-pane fade in active">
                    ...
                    <input type="button" onclick="edit_mapping('youtube')" id="btn_mapping_youtube" name="btn_mapping_youtube" class="btn btn-primary" value="<?php _e('Edit Youtube Mapping','tainacan'); ?>" /><br><br>
                ...
                <div id="aba-flickr" class="tab-pane fade">
                    ...
                    <input type="button" onclick="edit_mapping('flickr')" id="btn_mapping_flickr" name="btn_mapping_flickr" class="btn btn-primary" value="<?php _e('Edit Flickr Mapping','tainacan'); ?>" /><br><br>
                ...
                <div id="aba-faceboook" class="tab-pane fade">
                    ...
                    <input type="button" onclick="edit_mapping('facebook')" id="btn_mapping_facebook" name="btn_mapping_facebook" class="btn btn-primary" value="<?php _e('Edit Facebook Mapping','tainacan'); ?>" />
                    ...
                    <input type="button" onclick="edit_mapping('instagram')" id="btn_mapping_instagram" name="btn_mapping_instagram" class="btn btn-primary" value="<?php _e('Edit Instagram Mapping','tainacan'); ?>" /><br><br>
