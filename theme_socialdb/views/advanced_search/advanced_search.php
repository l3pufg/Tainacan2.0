...
<div style="margin-top: 10px;" class="row">
    ...
    <div class="col-md-10">
            ...
            <div class="panel-body">
                <div class="form-group">   
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="advanced_search_title" id="advanced_search_title" placeholder="<?php _e('Type the item title or its description','tainacan'); ?>">
                    </div>
                     <!--div class="form-group">
        ...
        <div class="col-md-12">
            ...
            <button type="submit" class="btn btn-lg btn-primary pull-right"><?php _e('Search','tainacan') ?></button>
        </div>
    </div>
    <div class="col-md-1"></div>
</div> 
