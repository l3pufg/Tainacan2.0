                            ...
                            $("#table_export_oaipmh_dc").append("<tr>");
                             if (object.size=== false || object.size === '') {
                                $("#table_export_oaipmh_dc").append("<td>" + object.name + "</td>" +
                                        "<td><a href='#' onclick=\"edit_mapping_oaipmh_export(" + object.id + "," + collectionId + ")\"><span class='glyphicon glyphicon-pencil'></span></a></td>" +
                                        "<td><a href='#' onclick='delete_mapping(" + object.id + "," + collectionId + " )'><span class='glyphicon glyphicon-trash'></span></a></td>" );
                            }
                            else {
                                $("#table_export_oaipmh_dc").append("<td>" + object.name + "</td>" +
                                        "<td><a href='#' ><?php _e('(Imported mapping)','tainacan') ?>&nbsp;<span style='opacity:0.4' class='glyphicon glyphicon-pencil'></span></a></td>" +
