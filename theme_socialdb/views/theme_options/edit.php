    ...
    <div class="col-md-9">
        <div class="row">
            ...
            <ul class="nav nav-tabs">
                ...
                <li role="presentation"><a href="#aba-embed-ly" aria-controls="property_object_tab" role="tab" data-toggle="tab"><?php _e('Embed.ly','tainacan') ?></a></li>
                <li role="presentation"><a href="#aba-google" aria-controls="property_object_tab" role="tab" data-toggle="tab"><?php _e('Google / Google +','tainacan') ?></a></li>
            </ul>
            <div class="tab-content">
                ...
                <!-- Aba do Embed.Ly-->
                <div id="aba-embed-ly" class="tab-pane fade">
                ...
                <!-- Aba do Google-->
                <div id="aba-google" class="tab-pane fade">
