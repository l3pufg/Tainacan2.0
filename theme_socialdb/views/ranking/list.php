...
<div class="fuelux">
    <div id="MyWizard" class="fuelux wizard">
        ...
        <ul class="steps fuelux step-content">
            <a onclick="showCollectionConfiguration('<?php echo get_template_directory_uri() ?>');"><li ><span class="fuelux badge">1</span><?php echo __("Configuration") ?><span class="chevron"></span></li></a>
