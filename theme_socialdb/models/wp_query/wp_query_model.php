...
class WPQueryModel extends Model {
    ...
    public function get_tax_query($recover_data) {
        ...
        if(isset($recover_data['collection_id'])&&$recover_data['collection_id']!=get_option('collection_root_id')){
            $tax_query[] = array(
    ...
    public function advanced_searched_filter($data) {
        ...
        $recover_data['category_root_id'] = $this->get_category_root($data['collection_id']);
