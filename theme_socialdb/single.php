...
<?php while (have_posts()) : the_post(); ?>
    ...
    <div id="main_part" >
        ...
        <div id="container_three_columns" class="container-fluid">  
            ...
            <div  id="div_central" class="col-md-10">
                    ...
                    <div class="col-md-12 search-colecao">
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                ...
                                <button onclick="clear_list()"id="clear" class="btn btn-default"><?php _e('Clear', 'tainacan') ?></button>
                            </span>
                        </div>
                        ...
                        <div class="col-md-12 text-right">
                            <a onclick="showAdvancedSearch('<?php echo get_template_directory_uri() ?>');" href="#">
                                <small>
                                    <span ><?php _e('Advanced Search', 'tainacan'); ?></span>
                        ...
                        <div class="row">
                            <?php if (get_option('collection_root_id') != get_the_ID()): ?>
                                <div class="col-md-1">
                                    <div class="btn-group" role="group" aria-label="...">
                                        <div class="btn-group" role="group" aria-label="...">
                                        <!--button type="button" id="create_button" class="btn btn-default"><?php _e('Add', 'tainacan') ?> <span class="glyphicon glyphicon-plus"></span></button-->
                                            <!-- Single button -->
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a  id="create_button" style="cursor: pointer;"><?php _e('Item', 'tainacan') ?></a></li>
                                                    <li><a onclick="showViewMultipleItems()" style="cursor: pointer;" ><?php _e('Multiple Files', 'tainacan') ?></a></li>
                                                    <!--li><a id="url_create_button" style="cursor: pointer;"><?php _e('URL', 'tainacan') ?></a></li>
                                                    <li role="separator" class="divider"></li>
                                                    <li class='disabled'><a href="#" ><?php _e('Social Media', 'tainacan') ?></a></li-->
                                                </ul>
                                            </div>
                            ...
                            <div class="col-md-4 flex-box">
                                ...
                                <select onchange="getOrder(this)" 
                                        ...
                                        id="collection_single_ordenation"
                                        style="margin-left: 5%;">
                            ...
                            <div class="col-md-7 pull-right">
                                <?php if (get_option('collection_root_id') != get_the_ID()): ?>
                                    <h5 class="text-right white"><?php _e('Number of objects: ', 'tainacan'); ?> <span id="show_total_number_items"></span></h5>
                                <?php else: ?>
                                    <h5 class="text-right white"><?php _e('Number of collections: ', 'tainacan'); ?> <span id="show_total_number_items"></span></h5>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                ...
                <div id="container_socialdb" class="row">
            ...
            <div class="modal-content">
                <form  id="submit_adicionar_category_single">   
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-plus"></span>&nbsp;<?php echo __('Add Category', 'tainacan'); ?></h4>
                    </div>
